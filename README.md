...
For continued practice with Backbone view I created a loading button that uses AJAX calls to Backbone collections.
...
which is located [HERE]
   ...
   [HERE]: <https://frazierr2.github.io/6.2-loading-button/>
